...
namespace MainServer
{
    public class Pokoj
    {
        ...
        public void rozdanie()
        {
          ...
          /*  user[0].hand.Add(new Karta { figura = Karta.figuraKarty.K2, kolor = Karta.kolorKarty.karo });
            user[0].hand.Add(new Karta { figura = Karta.figuraKarty.KK, kolor = Karta.kolorKarty.trefl });
            user[1].hand.Add(new Karta { figura = Karta.figuraKarty.K2, kolor = Karta.kolorKarty.pik });
            user[1].hand.Add(new Karta { figura = Karta.figuraKarty.KD, kolor = Karta.kolorKarty.kier });
            user[2].hand.Add(new Karta { figura = Karta.figuraKarty.K4, kolor = Karta.kolorKarty.pik });
            user[2].hand.Add(new Karta { figura = Karta.figuraKarty.K2, kolor = Karta.kolorKarty.trefl });*/
        }
        ...
        public void losujNaStol(int ile)
        {
           ...
           /* stol.Add(new Karta { figura = Karta.figuraKarty.KA, kolor = Karta.kolorKarty.karo });
            stol.Add(new Karta { figura = Karta.figuraKarty.KJ, kolor = Karta.kolorKarty.kier });
            stol.Add(new Karta { figura = Karta.figuraKarty.K9, kolor = Karta.kolorKarty.trefl });
            stol.Add(new Karta { figura = Karta.figuraKarty.K7, kolor = Karta.kolorKarty.karo });
            stol.Add(new Karta { figura = Karta.figuraKarty.K5, kolor = Karta.kolorKarty.pik });*/
        }
        ...
        private void pobierzUserow()
        {
            ...
            user.Add(new Uzytkownik { identyfikatorUzytkownika = 4, nazwaUzytkownika = "Piotras", numerPokoju = 1 });
            user.Add(new Uzytkownik { identyfikatorUzytkownika = 5, nazwaUzytkownika = "Maras", numerPokoju = 1 });
        }
        ...
        public List<Uzytkownik> ktoWygral()
        {
            ...
            for (int i = 0; i < user.Count; i++)
            {
                ...
                {
                    user[i].wart = wartosci(user[i].nazwaUkladu);                   
                }
                user.Sort(sw);
            }
            max = user[0].wart;
        ...
        private void funkcPom(List<Uzytkownik> wygrani, List<Uzytkownik> user2) //sprawdza kickery w rece
        {
        ...
        private List<Uzytkownik> PokerComp(List<Uzytkownik> wygrani, int ile)
        {
            wygrani.Clear();
        ...
        private List<Uzytkownik> KaretaComp(List<Uzytkownik> wygrani, int ile)
        {
            wygrani.Clear();
        ...
        private List<Uzytkownik> FullComp(List<Uzytkownik> wygrani, int ile)
        {
            wygrani.Clear();
            for (int i = 0; i < ile; i++)
            {
        ...
        private List<Uzytkownik> KolorComp(List<Uzytkownik> wygrani, int ile)
        {
            wygrani.Clear();
            for (int i = 0; i < ile; i++)
            {
        ...
        private List<Uzytkownik> StritComp(List<Uzytkownik> wygrani, int ile)
        {
            wygrani.Clear();
            List<Uzytkownik> temp = new List<Uzytkownik>();
            for (int i = 0; i < ile; i++)
        ...
        private List<Uzytkownik> TrojkaComp(List<Uzytkownik> wygrani, int ile)
        {
            wygrani.Clear();
        ...
        private List<Uzytkownik> DwieParyComp(List<Uzytkownik> wygrani, int ile)
        {
            wygrani.Clear();
            for (int i = 0; i < ile; i++)
            {
        ...
        private List<Uzytkownik> ParaComp(List<Uzytkownik> wygrani, int ile)
        {
            wygrani.Clear();
            for (int i = 0; i < ile; i++)
            {
        ...
        private List<Uzytkownik> WysokaKartaComp(List<Uzytkownik> wygrani, int ile)
        {
            wygrani.Clear();
            for (int i = 0; i < ile; i++)
            {
